        ...
        <div class="col-lg-8">
          <div class="card shadow-sm">
            <div class="card-header bg-white border-bottom">
              <h5 class="card-title mb-0">Dish Information</h5>
            </div>
            <div class="card-body">
              <form @submit.prevent="submit">
                <div class="row g-4">
                  ...
                  <div class="col-md-6">
                    ...
                    <input
                      ...
                      placeholder="e.g., Ijebu-Ode, Ijebu-Igbo"
                    >
                    <div class="invalid-feedback" v-if="form.errors.region">
                      {{ form.errors.region }}
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <textarea
                      ...
                      rows="3"
                      class="form-control"
                      :class="{ 'is-invalid': form.errors.ingredients }"
                      placeholder="List main ingredients separated by commas"
                    />
                    <div class="invalid-feedback" v-if="form.errors.ingredients">
                  ...
                  <div class="col-12">
                    ...
                    <textarea
                      ...
                      rows="4"
                      class="form-control"
                      :class="{ 'is-invalid': form.errors.preparation_method }"
                    />
                    <div class="invalid-feedback" v-if="form.errors.preparation_method">
                      {{ form.errors.preparation_method }}
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    ...
                    <textarea
                      ...
                      v-model="form.cultural_significance"
                      rows="3"
                      class="form-control"
                      :class="{ 'is-invalid': form.errors.cultural_significance }"
                    />
                    <div class="invalid-feedback" v-if="form.errors.cultural_significance">
                      {{ form.errors.cultural_significance }}
                    </div>
                  </div>
                ...
                <div class="mt-4 d-flex justify-content-end">
                  <inertia-link
                    v-if="food"
                    :href="$route('admin.foods.show', food.id)"
          ...
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" :value="food ? formatDate(food.updated_at) : 'Now'" readonly>
              </div>

              <div class="mb-0">
                <label class="form-label">Created By</label>
                <input type="text" class="form-control" :value="food ? food.created_by : currentUser()" readonly>
              </div>
            </div>
          </div>

          <!-- Image Information Card -->
          <div v-if="food && food.featuredImage" class="card shadow-sm mt-4">
            <div class="card-header bg-white border-bottom">
              <h5 class="card-title mb-0">Current Image</h5>
            </div>
            <div class="card-body">
              <div class="text-center">
                <img :src="'/storage/' + food.featuredImage.path" :alt="food.featuredImage.filename" class="img-fluid rounded mb-3" style="max-height: 200px;">
                <div>
                  <strong>{{ food.featuredImage.filename }}</strong>
                  <div class="text-muted">{{ food.featuredImage.mime }} • {{ formatBytes(food.featuredImage.size) }}</div>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      form: this.$inertia.form({
        ...
        preparation_method: this.food?.preparation_method || '',
        cultural_significance: this.food?.cultural_significance || '',
        ingredients: this.food?.ingredients || '',
        region: this.food?.region || '',
        is_featured: this.food?.is_featured || false,
        media_id: this.food?.media_id || '',
        image: null,
        imagePreview: null
      })
    }
  ...
  methods: {
    ...
    submit() {
      ...
      formData.append('preparation_method', this.form.preparation_method || '')
      formData.append('cultural_significance', this.form.cultural_significance || '')
      ...
      if (this.food) {
        this.form.post(this.$route('admin.foods.update', this.food.id), {
          data: formData,
          headers: {
        ...
        this.form.post(this.$route('admin.foods.store'), {
          data: formData,
          headers: {
            'Content-Type': 'multipart/form-data',
          },
