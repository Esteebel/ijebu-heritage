                ...
                <div class="row g-4">
                  ...
                  <div class="col-md-6">
                    ...
                    <input
                      ...
                      v-model="form.historical_period"
                      type="text"
                      class="form-control"
                      :class="{ 'is-invalid': form.errors.historical_period }"
                      placeholder="e.g., 15th Century, Colonial Era"
                    >
                    <div class="invalid-feedback" v-if="form.errors.historical_period">
                      {{ form.errors.historical_period }}
                    </div>
                  </div>

                  <div class="col-md-6">
                    <label for="preservation_status" class="form-label">Preservation Status</label>
                    <input
                      id="preservation_status"
                      v-model="form.preservation_status"
                      type="text"
                      class="form-control"
                      :class="{ 'is-invalid': form.errors.preservation_status }"
                      placeholder="e.g., Well-preserved, Partially Destroyed"
                    >
                    <div class="invalid-feedback" v-if="form.errors.preservation_status">
                      {{ form.errors.preservation_status }}
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <input
                      ...
                      placeholder="e.g., 6.7890"
                    >
                    <div class="invalid-feedback" v-if="form.errors.latitude">
                  ...
                  <div class="col-md-6">
                    ...
                    <input
                      ...
                      placeholder="e.g., 3.4567"
                    >
                    <div class="invalid-feedback" v-if="form.errors.longitude">
                  ...
                  <div class="col-12">
                    <label class="form-label">Site Image</label>
          ...
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" :value="site ? formatDate(site.updated_at) : 'Now'" readonly>
              </div>

              <div class="mb-0">
                <label class="form-label">Created By</label>
                <input type="text" class="form-control" :value="site ? site.created_by : currentUser()" readonly>
              </div>
            </div>
          </div>

          <!-- Image Information Card -->
          <div v-if="site && site.featuredImage" class="card shadow-sm mt-4">
            <div class="card-header bg-white border-bottom">
              <h5 class="card-title mb-0">Current Image</h5>
            </div>
            <div class="card-body">
              <div class="text-center">
                <img :src="'/storage/' + site.featuredImage.path" :alt="site.featuredImage.filename" class="img-fluid rounded mb-3" style="max-height: 200px;">
                <div>
                  <strong>{{ site.featuredImage.filename }}</strong>
                  <div class="text-muted">{{ site.featuredImage.mime }} • {{ formatBytes(site.featuredImage.size) }}</div>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      form: this.$inertia.form({
        ...
        historical_period: this.site?.historical_period || '',
        significance: this.site?.significance || '',
        preservation_status: this.site?.preservation_status || '',
        latitude: this.site?.latitude || null,
        longitude: this.site?.longitude || null,
        is_featured: this.site?.is_featured || false,
        media_id: this.site?.media_id || '',
        image: null,
        imagePreview: null
      })
    }
  ...
  methods: {
    ...
    submit() {
      ...
      formData.append('historical_period', this.form.historical_period || '')
      formData.append('significance', this.form.significance || '')
      formData.append('preservation_status', this.form.preservation_status || '')
      ...
      if (this.site) {
        this.form.post(this.$route('admin.sites.update', this.site.id), {
          data: formData,
          headers: {
        ...
        this.form.post(this.$route('admin.sites.store'), {
          data: formData,
          headers: {
            'Content-Type': 'multipart/form-data',
          },
