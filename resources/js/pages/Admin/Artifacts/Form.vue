    ...
    <div class="container-fluid py-4">
      ...
      <div class="row">
            ...
            <div class="card-body">
              <form @submit.prevent="submit">
                <div class="row g-4">
                  ...
                  <div class="col-md-6">
                    ...
                    <input
                      ...
                      type="text"
                      class="form-control"
                      :class="{ 'is-invalid': form.errors.accession_number }"
                    >
                    <div class="invalid-feedback" v-if="form.errors.accession_number">
                      {{ form.errors.accession_number }}
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    >
                    <div class="invalid-feedback" v-if="form.errors.tags">
                      {{ form.errors.tags }}
                    </div>
                  </div>
                ...
                <div class="mt-4 d-flex justify-content-end">
                  <inertia-link
                    v-if="artifact"
                    :href="$route('admin.artifacts.show', artifact.id)"
        ...
        <div class="col-lg-4">
          ...
          <div v-if="artifact && artifact.media" class="card shadow-sm mt-4">
            <div class="card-header bg-white border-bottom">
              <h5 class="card-title mb-0">Current Image</h5>
            </div>
            <div class="card-body">
              <div class="text-center">
                <img :src="'/storage/' + artifact.media.path" :alt="artifact.media.filename" class="img-fluid rounded mb-3" style="max-height: 200px;">
                <div>
                  <strong>{{ artifact.media.filename }}</strong>
                  <div class="text-muted">{{ artifact.media.mime }} • {{ formatBytes(artifact.media.size) }}</div>
                </div>
              </div>
            </div>
          </div>
...
export default {
  ...
  data() {
    return {
      form: this.$inertia.form({
        ...
        accession_number: this.artifact?.accession_number || '',
        tags: this.artifact?.tags || '',
  ...
  methods: {
    ...
    submit() {
      ...
      formData.append('accession_number', this.form.accession_number || '')
      ...
      if (this.artifact) {
        this.form.post(this.$route('admin.artifacts.update', this.artifact.id), {
          data: formData,
          headers: {
        ...
        this.form.post(this.$route('admin.artifacts.store'), {
          data: formData,
          headers: {
            'Content-Type': 'multipart/form-data',
          },
