<template>
  <AdminLayout>
    <div class="container-fluid">
      <div class="row mb-4">
        <div class="col">
          <h1>Edit Photo Archive</h1>
          <p class="text-muted">Update photo archive details</p>
        </div>
      </div>
          ...
          <form @submit.prevent="submit">
            ...
            <div class="d-flex gap-2">
              ...
              <button type="submit" class="btn btn-primary" :disabled="processing">
                ...
                <span v-else>Update Photo Archive</span>
              </button>
            </div>
          </form>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        ...
        featured_image_id: this.archive.featured_image_id,
        image: null,
        imagePreview: null
      },
      errors: {},
  ...
  methods: {
    ...
    async submit() {
      ...
      try {
        await this.$inertia.post(this.$route('admin.photo.archives.update', this.archive.id), formData, {
          onSuccess: () => {
        ...
        this.processing = false;
        console.error('Error updating photo archive:', error);
      }
    }
  },
  mounted() {
