<template>
  <AdminLayout>
    <div class="container-fluid">
      <div class="row mb-4">
        <div class="col">
          <h1>Edit Olu's Corner Entry</h1>
          <p class="text-muted">Update entry details</p>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      form: {
        ...
        is_published: this.entry.is_published || false,
        featured_media_id: this.entry.featured_media_id || null,
        image: null,
        imagePreview: null
      },
      errors: {}
  ...
  methods: {
    ...
    async submit() {
      ...
      try {
        await this.$inertia.post(this.$route('admin.olu.corner.update', this.entry.id), formData, {
          onSuccess: () => {
