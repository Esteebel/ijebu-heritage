  ...
  <admin-layout>
    ...
    <div class="container-fluid py-4">
      <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">
          {{ kingdom ? 'Edit Kingdom' : 'Create Kingdom' }}
        </h1>
        <inertia-link
          v-if="kingdom"
      ...
      <div class="row">
                ...
                <div class="row g-4">
                  ...
                  <div class="col-12">
                    ...
                    <textarea
                      ...
                      placeholder="Enter kingdom description"
                    />
        ...
        <div class="col-lg-4">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              <p class="mb-0">
                A kingdom represents a sovereign state ruled by a monarch. Please provide accurate historical information when creating or editing a kingdom.
              </p>
            </div>
          </div>
        </div>
  ...
  data() {
    return {
      ...
      form: this.$inertia.form({
        ...
        start_year: this.kingdom?.start_year || null,
        end_year: this.kingdom?.end_year || null,
      })
    }
  },
  methods: {
    submit() {
      ...
      if (this.kingdom) {
        this.form.put(this.$route('admin.dynasties.update', this.kingdom.id), {
          onFinish: () => {
